...
if (isset($_FILES["fileToUpload"])) { // check if a file has been upload
	...
	$file_size = $_FILES["fileToUpload"]["size"]; // retrieve the uploaded file size
	$file_tmp = $_FILES["fileToUpload"]["tmp_name"]; // retrieve the uploaded file tmp_name
	$file_type = $_FILES["fileToUpload"]["type"];
	$file_parts = explode(".", $file_name); // retrieve uploaded file extension
	$file_ext = strtolower(end($file_parts)); // trunc the uploaded file extension to a lower case string
	$target_dir = "uploads"; // set the upload directiory
